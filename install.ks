# Install CA
%pre-install --log=/tmp/ca.log
mkdir -p /mnt/sysimage/etc/pki/ca-trust/source/anchors

cat <<'EOF' > /mnt/sysimage/etc/pki/ca-trust/source/anchors/my-ca.crt
-----BEGIN CERTIFICATE-----
...
chroot /mnt/sysimage update-ca-trust
%end
